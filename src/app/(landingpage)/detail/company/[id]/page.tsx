      ...
      <div className="bg-slate-100 px-32 pt-16 pb-14">
        <div>
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbLink href="/find-companies">
                  Companies
                </BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator />
        ...
        <div>
          <div className="mt-10 inline-flex gap-6 items-start">
            <Image
              src={
                company.detail ? company.detail.image : '/images/company2.png'
              }
              alt="image"
              width={100}
              height={100}
            ...
            <div>
              <div className="inline-flex gap-4 items-center">
                <span className="text-4xl font-semibold">{company.name}</span>
                <Badge>{company.totalJobs} Jobs</Badge>
              </div>
                ...
                <div className="inline-flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="font-semibold">
                      {dateFormat(company.detail.dateFounded, 'MMMM, DD YYYY')}
                    </div>
                  </div>
                </div>
      ...
      <div className="px-32 py-16 flex flex-row items-start gap-10">
          ...
          <div className="mb-16">
            ...
            <div
              ...
              dangerouslySetInnerHTML={{
                __html: company.detail.description ?? '<p>N/a</p>',
              }}
            ></div>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-5 w-[400px] flex-wrap">
              <div className="p-2 border border-primary text-primary w-max inline-flex items-center gap-3 font-semibold">
                ...
                <Link
                  href={
                    company.socialMedia ? company.socialMedia.facebook : 'n/a'
                  }
                >
              ...
              <div className="p-2 border border-primary text-primary w-max inline-flex items-center gap-3 font-semibold">
                ...
                <Link
                  href={
                    company.socialMedia ? company.socialMedia.twitter : 'n/a'
                  }
                >
        ...
        <div className="w-1/4">
          ...
          <div className="mt-5 flex flex-row items-center flex-wrap gap-4">
            {company.detail.techStack
              ? company.detail.techStack.map((item: any, i: number) => (
