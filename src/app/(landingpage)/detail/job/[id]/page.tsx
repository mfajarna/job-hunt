...
async function getDetailJob(id: string) {
  ...
  if (data?.Company?.CompanyOverview[0]) {
...
export default async function DetailJobPage({
  ...
  return (
    <>
      <div className="px-32 pt-10 pb-14">
        <div>
          <Breadcrumb>
            <BreadcrumbList>
              <BreadcrumbItem>
              ...
              <BreadcrumbItem>
                <BreadcrumbLink
                  href={`/detail/company/${
                    data?.Company?.CompanyOverview[0].id ?? ''
                  }`}
                >
                  {data?.Company?.CompanyOverview[0].companyName}
                </BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbLink href={`/detai/job/${data?.id}`}>
                  {data?.roles}
                </BreadcrumbLink>
              </BreadcrumbItem>
            </BreadcrumbList>
