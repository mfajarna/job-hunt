...
const CFooter: FC<FooterProps> = ({}) => {
  return (
    <div className="bg-slate-900  pt-16 pb-11 px-32 relative">
      <div className="flex flex-row items-start justify-between">
        <div>
          <Image src="/images/logo.png" alt="image" width={160} height={36} />
      ...
      <div className="flex flex-row items-center justify-center">
        <div className="text-slate-600 px-2">
          {new Date().getFullYear()} @ JobHuntly. All rights.
        </div>
